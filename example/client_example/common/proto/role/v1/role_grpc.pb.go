...
const (
	...
	RoleService_BatchGetRoles_FullMethodName = "/role.v1.RoleService/BatchGetRoles"
)
...
func (c *roleServiceClient) BatchGetRoles(ctx context.Context, in *BatchGetRolesReq, opts ...grpc.CallOption) (*BatchGetRolesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRoleServiceServer) BatchGetRoles(context.Context, *BatchGetRolesReq) (*BatchGetRolesResp, error) {
...
func _RoleService_BatchGetRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).BatchGetRoles(ctx, req.(*BatchGetRolesReq))
	}
	return interceptor(ctx, in, info, handler)
}
